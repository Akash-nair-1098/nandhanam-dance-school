  ...
  return (
    <>
      ...
      <main className="page-content themed-page">
        ...
        <Suspense
          fallback={
            <div className="py-5 text-center" style={{ color: "#4F46E5" }}>
        ...
        <Suspense
          fallback={
            <div className="py-5 text-center" style={{ color: "#EA580C" }}>
              Loading Gallery...
            </div>
          }
        >
          ...
          <div className="container">
            <div className="row align-items-center g-4">
              <div className="col-lg-6">
                <h2 className="fw-bold mb-3">Have something to say?</h2>
                <p className="text-muted">
                  Submit your enquiries through the form so that we can serve
                  you better!
                </p>
              </div>
                ...
                >
                  <div className="card-body p-4">
                    <form onSubmit={handleSubmit}>
                      ...
                      {status.error && (
                        <p className="text-danger mt-3 mb-0">{status.error}</p>
                      )}
                    </form>
                  </div>
                </div>
